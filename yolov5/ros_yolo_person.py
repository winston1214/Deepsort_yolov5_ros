...
class ROS:
    def __init__(self):
        ...
        self.path = 'ros.jpg'
        self.rviz_pub = rospy.Publisher('yolov5',Image,queue_size=1)
    ...
    def image_callback(self,msg):
        ...
        try:
            ...
            # print("How long cv_bridge",cv_end-cv_start)
        except CvBridgeError as e:
            print(e)
        # self.cv_image = cv2.resize(self.cv_image,(0,0),fx=0.5,fy=0.5,interpolation=cv2.INTER_LINEAR)
