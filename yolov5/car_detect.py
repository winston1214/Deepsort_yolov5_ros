                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if label == 'car':
                            ...
                            if len(input_data) >=2 and names[int(cls)] == 'car' :
                                ...
                                if TTC <= 5:
                                    cv2.putText(im0, "STATUS : DANGER", (1020, 50), cv2.FONT_HERSHEY_COMPLEX, 1.0,
                                                (0, 0, 255), 3)
                                else:
                                    cv2.putText(im0, "STATUS : SAFE", (1020, 50), cv2.FONT_HERSHEY_COMPLEX, 1.0,
                                                (255, 125, 255), 3)
